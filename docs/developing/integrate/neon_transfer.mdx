...
<!-- todo confirm ok to remove only NEON -- we have other supported SPL tokens -->

## Prerequisites

- You need to provide Solana and Neon EVM providers from supported official libraries such as `@solana/web3.js` or `web3.js`
, `ether.js`, and `WalletConnect`. 
...
Within the Neon Transfer codebase, we employ the [web3.js](https://web3js.readthedocs.io/en/v1.10.0/) library to streamline our code. However, you can opt for alternatives such as [@solana/web3.js](https://docs.solana.com/developing/clients/javascript-api), [ethers.js](https://docs.ethers.org/v6/), or [WalletConnect](https://walletconnect.com/).
